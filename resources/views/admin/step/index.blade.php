            ...
            <div class="card-body p-24">
                <div class="tab-content" id="pills-tabContent">
                                            ...
                                            <div class="modal-dialog modal-lg">
                                              <div class="modal-content">
                                                <div class="modal-header">
                                                  <h5 class="modal-title" id="modalLabel">Edit {{ $steps->nama }}</h5>
                                                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <form id="editStepForm{{ $steps->id }}" enctype="multipart/form-data" action="{{ route('editStepByStep',encrypt($steps->id)) }}" method="POST">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <div class="mb-20">
                                                                    <label for="name" class="form-label fw-semibold text-primary-light text-sm mb-8">Nama <span class="text-danger-600">*</span></label>
                                                                    <input type="number" name="nomor" class="form-control radius-8" id="nomor" placeholder="Masukan nomor urutan" value="{{ $steps->nomor }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-12">
                                                                <div class="mb-20">
                                                                    <label for="name" class="form-label fw-semibold text-primary-light text-sm mb-8">Nama <span class="text-danger-600">*</span></label>
                                                                    <input type="text" name="nama" class="form-control radius-8" id="name" placeholder="Masukan nama Produk" value="{{ $steps->nama }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-12">
                                                                <div class="mb-20">
                                                                    ...
                                                                    <div class="imagePreview d-flex justify-content-center align-items-center">
                                                                        <img id="previewImg{{ $steps->id }}" class="rounded" style="display: none; max-width: 200px; height: auto;">
                                                                    </div>
                                                                    <input type="file" name="gambar" class="form-control radius-8 mt-3" id="gambar{{ $steps->id }}" accept="image/*">
                                                                </div>
                                                            </div>
                                                            <script>
                                                ...
                                                <div class="modal-footer">
                                                  ...
                                                  <button type="button" class="btn btn-primary" onclick="event.preventDefault();
                                                     document.getElementById('editStepForm{{ $steps->id }}').submit();">Simpan</button>
                                                </div>
                                              </div>
                                            </div>
                                        </div>
                    ...
                    <div class="tab-pane fade" id="pills-ui-design" role="tabpanel" aria-labelledby="pills-ui-design-tab" tabindex="0">
                        <form id="StepaddForm" data-id="{{ route('createStepByStep') }}">
                            @csrf
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="mb-20">
                                        <label for="name" class="form-label fw-semibold text-primary-light text-sm mb-8">Nomor <span class="text-danger-600">*</span></label>
                                        <input type="number" name="nomor" class="form-control radius-8" id="nomor" placeholder="Masukan Nomor Step" value="">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="mb-20">
                                ...
                                $("#StepaddForm").submit(function (e) {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (response) {
                                            ...
                                            $("#dataTableStep").append(`
                                                <tr>
                                                    <td>${response.nomor}</td>
                                                    <td>${response.nama}</td>
                                                    <td>
                                                        <img src="{{ asset('storage/step_image/') }}/${response.gambar}" style="width: 90px;" alt="" id="gambarmenu" class="flex-shrink-0 me-12 radius-8">
                                                    </td>
                                                    <td>
