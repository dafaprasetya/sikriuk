        ...
        <div class="about-wrapper-2">
            <div class="row align-items-center">
                <div class="col-xl-5 col-lg-5 wow fadeInUp" data-wow-delay=".7s">
                    <div class="pizza-image wow fadeInUp" data-wow-delay=".7s">
                ...
                <div class="col-xl-7 col-lg-7 mt-5 mt-lg-0">
                    <div class="about-content wow fadeInUp" data-wow-delay=".7s">
                        ...
                        <div class="about-info">
                            ...
                            <a href="{{ route('profile') }}" class="theme-btn-2 wow fadeInUp popinsfont" data-wow-delay=".7s">Lihat profil perusahaan</a>
                        </div>
                    </div>
                </div>
            </div>
