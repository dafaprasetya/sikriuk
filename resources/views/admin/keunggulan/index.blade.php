            ...
            <div class="card-body p-24">
                <div class="tab-content" id="pills-tabContent">
                                            ...
                                            <div class="modal-dialog modal-lg">
                                              <div class="modal-content">
                                                <div class="modal-header">
                                                  <h5 class="modal-title" id="modalLabel">Edit {{ $keunggulans->nama }}</h5>
                                                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <form id="editKeunggulanForm{{ $keunggulans->id }}" enctype="multipart/form-data" action="{{ route('editKeunggulan',encrypt($keunggulans->id)) }}" method="POST">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <div class="mb-20">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="mb-20">
                                                                    ...
                                                                    <input type="text" name="nama" class="form-control radius-8" id="name" placeholder="Masukan nama" value="{{ $keunggulans->nama }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-12">
                                                                <div class="mb-20">
                                                ...
                                                <div class="modal-footer">
                                                  ...
                                                  <button type="button" class="btn btn-primary" onclick="event.preventDefault();
                                                     document.getElementById('editKeunggulanForm{{ $keunggulans->id }}').submit();">Simpan</button>
                                                </div>
                                              </div>
                                            </div>
                                        </div>
                    ...
                    <div class="tab-pane fade" id="pills-ui-design" role="tabpanel" aria-labelledby="pills-ui-design-tab" tabindex="0">
                        <form id="kgaddForm" data-id="{{ route('createKeunggulan') }}">
                            @csrf
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="mb-20">
