...
<section class="about-section section-padding pt-0 mt-8">
                    ...
                    <div class="about-content">
                        <div class="section-title">
                            ...
                            <h2 class="wow fadeInUp" data-wow-delay=".3s">
                                Sikriuk Fried Chicken <br>
                                <small>PT. Inti Kriuk Indonesia</small>
                            </h2>
                        </div>
                        ...
                        <div class="about-info">
                            ...
                            <a href="about.html" class="theme-btn-2 wow fadeInUp" data-wow-delay=".5s">Gabung Mitra Sekarang</a>
                        </div>
                    </div>
                </div>
            </div>
